...
//create the DERs, ingress, egress, and the aggregator nodes
  ...
  // Explicitly create the channels required by the topology (shown above).
    ...
    // We create the channels first without any IP addressing information
      ...
      p2p.SetChannelAttribute ("Delay",  TimeValue (NanoSeconds (0)));
      PointerValue ptr;

      NetDeviceContainer d0d1 = p2p.Install (n0n1);
      d0d1.Get(0)->GetAttribute ("TxQueue", ptr);
      Ptr<Queue<Packet> > txQueue = ptr.Get<Queue<Packet> > ();
      txQueue->SetMaxSize( QueueSize (QueueSizeUnit::PACKETS, 10));
...
//**********************Application Layer**************************************************
       ...
       appDER1Extern->Setup (DERs.Get(0),Ipv4Address ("10.1.6.2"),Ipv4Address ("10.1.8.5"), 7001,7001,FORWARDING_NODE);
       ...
       appDER2Extern->Setup (DERs.Get(1),Ipv4Address ("10.1.6.6"),Ipv4Address ("10.1.8.5"), 7001,7001,FORWARDING_NODE);
       ...
       appDER3Extern->Setup (DERs.Get(2),Ipv4Address ("10.1.6.10"),Ipv4Address ("10.1.8.5"), 7001,7001,FORWARDING_NODE);
       ...
       appDER4Extern->Setup (DERs.Get(3),Ipv4Address ("10.1.6.14"),Ipv4Address ("10.1.8.5"), 7001,7001,FORWARDING_NODE);
       ...
       appAggregatorIntern->Setup (Aggregator,Ipv4Address ("10.1.8.5"),Ipv4Address ("10.1.8.6"), 7001,7001,FORWARDING_NODE);
       ...
       appDER1Intern->Setup (DERs.Get(0),Ipv4Address ("10.1.7.2"),Ipv4Address ("10.1.8.6"), 7001,7001,FORWARDING_NODE);
       ...
       appDER2Intern->Setup (DERs.Get(1),Ipv4Address ("10.1.7.6"),Ipv4Address ("10.1.8.6"), 7001,7001,FORWARDING_NODE);
       ...
       appDER3Intern->Setup (DERs.Get(2),Ipv4Address ("10.1.7.10"),Ipv4Address ("10.1.8.6"), 7001,7001,FORWARDING_NODE);
       ...
       appDER4Intern->Setup (DERs.Get(3),Ipv4Address ("10.1.7.14"),Ipv4Address ("10.1.8.6"), 7001,7001,FORWARDING_NODE);
