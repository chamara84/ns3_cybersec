...
//		   				   		   			}
		   				   		   	UdpHeader udpHdr;
		   				   		   				  		   		Ipv4Header ipV4Hdr;
		   				   		   				  		   		ipV4Hdr.SetSource(Ipv4Address("10.0.3.16"));
	       ...
	       if(type==5 || type==8)
	       {
	    	   ...
	    	   udpHdr.InitializeChecksum(Ipv4Address("10.0.3.16"),Ipv4Address(to.c_str ()),17);
...
//
       ...
       Ptr<Ipv4> ipv4_egressNode = egressNode->GetObject<Ipv4>();
         ...
         staticRouting_egressNode->SetDefaultRoute(Ipv4Address ("10.0.3.1"),2,0);
