...
class Icmpv4RedirectionHeader : public Header
{
public:
  /**
   ...
   */
  static TypeId GetTypeId (void);
  Icmpv4RedirectionHeader ();
  virtual ~Icmpv4RedirectionHeader ();
...
private:
  ...
  uint8_t	m_type;
  uint8_t	m_code;
  uint8_t *m_data;     //!< carried data
  Ipv4Header m_header;   //!< carried IPv4 headerm_header
  bool m_calcChecksum;  //!< true if checksum is calculated
