...
#ifndef IEC104_APP__H
#define IEC104_APP__H
...
#define IEC104_CLIENT 1
#define IEC104_SERVER 0
/* Memcap limits. */
...
typedef struct _iec104_session_data
{
    ...
    /* Reassembly stuff */
	std::multimap<uint32_t,iec104_Object_header_t *>  hash;
	uint8_t direction;
	iec104_header_t *linkHeader;
